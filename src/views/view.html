...
<body>
    ...
    <script>
        ...
        class TaskManager {
            ...
            createTask(title, type, assignee) {
                let task;
                switch(type) {
                    case 'bug':
                        task = new BugTask(title, assignee);
                        break;
                    case 'feature':
                        task = new FeatureTask(title, assignee);
                        break;
                    default:
                        task = new Task(title, assignee);
                }
        ...
        const users = ['John Doe', 'Jane Smith']; // Simulé - à remplacer par une vraie source de données
