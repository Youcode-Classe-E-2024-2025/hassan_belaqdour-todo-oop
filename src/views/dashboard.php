...
<body>
    ...
    <main class="container">
        ...
        <section id="new-task-form" class="section" style="display: none;">
            ...
            <form action="src/controllers/TaskController.php" method="post"  id="task-form">
                ...
                <div class="form-group">
                    ...
                    <select id="task-assignee" class="form-control" name="assignee" >
                ...
                <button name="add_task" value="submit" type="submit" class="btn btn-primary">Créer</button>
            </form>
        </section>
    </main>
